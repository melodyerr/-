...
for i=1:ClassNum
	...
	for P1=1:200
	    for P2=1:200
		    if(P1~=P2)
			    Sample(TC,1:200) = Ab_Sample(P1,:);
                Sample(TC,201:400) = Ab_Sample(P2,:);
                TC=TC+1;
            end
        end
    end
...
for i = 1:ClassNum  % 9
    ...
    for j = 1:ClassNum  % 9
        if(i~=j)
            ...
            for s1 = 1:200
                for s2 = 1:3
                    Sample(cc,1:200) = NowData(s1,:);
                    Sample(cc,201:400) = Selected(s2,:);
                    cc = cc+1;
                end
            end
        end
